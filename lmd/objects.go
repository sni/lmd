...
func NewHostsTable() (t *Table) {
	...
	t.AddColumn("custom_variable_names", StaticUpdate, StringListCol, "A list of the names of all custom variables")
...
func NewServicesTable() (t *Table) {
	...
	t.AddColumn("custom_variables", StaticUpdate, CustomVarCol, "A dictionary of the custom variables")
	t.AddColumn("custom_variable_names", StaticUpdate, StringListCol, "A list of the names of all custom variables of the service")
