...
func InitObjects() {
	...
	Objects.AddTable(NewBackendsTable())
	Objects.Tables[TableSites] = Objects.Tables[TableBackends]
	Objects.AddTable(NewColumnsTable())
	...
	Objects.AddTable(NewStatusTable())
	Objects.AddTable(NewTimeperiodsTable())
	Objects.AddTable(NewContactsTable())
	Objects.AddTable(NewContactgroupsTable())
	Objects.AddTable(NewCommandsTable())
	Objects.AddTable(NewHostsTable())
	Objects.AddTable(NewHostgroupsTable())
	Objects.AddTable(NewServicesTable())
	Objects.AddTable(NewServicegroupsTable())
	Objects.AddTable(NewCommentsTable())
	Objects.AddTable(NewDowntimesTable())
	Objects.AddTable(NewLogTable())
...
func (o *ObjectsType) AddTable(table *Table) {
	name := table.name
...
func NewBackendsTable() (t *Table) {
	t = &Table{name: TableBackends, virtual: GetTableBackendsStore, worksUnlocked: true}
	...
	t.AddPeerInfoColumn("queries", Int64Col, "Number of queries sent to this peer")
...
func NewColumnsTable() (t *Table) {
	t = &Table{name: TableColumns, virtual: GetTableColumnsStore, defaultSort: []string{"table", "name"}, worksUnlocked: true}
...
func NewStatusTable() (t *Table) {
	t = &Table{name: TableStatus}
	t.AddColumn("program_start", Dynamic, Int64Col, "The time of the last program start as UNIX timestamp")
	t.AddColumn("accept_passive_host_checks", Dynamic, IntCol, "Whether passive host checks are accepted in general (0/1)")
	t.AddColumn("accept_passive_service_checks", Dynamic, IntCol, "Whether passive service checks are accepted in general (0/1)")
	t.AddColumn("cached_log_messages", Dynamic, Int64Col, "The current number of log messages Livestatus keeps in memory")
...
func NewTimeperiodsTable() (t *Table) {
	...
	t.AddExtraColumn("id", LocalStore, Static, Int64Col, Naemon, "The id of the timeperiods")
...
func NewContactsTable() (t *Table) {
	...
	t.AddExtraColumn("id", LocalStore, Static, StringCol, Naemon, "The internal id of the contact")
	t.AddExtraColumn("modified_attributes", LocalStore, Dynamic, Int64Col, Naemon, "A bitmask specifying which attributes have been modified")
	t.AddExtraColumn("modified_attributes_list", LocalStore, Dynamic, StringListSortedCol, Naemon, "A bitmask specifying which attributes have been modified")
	...
	t.AddExtraColumn("groups", LocalStore, Static, StringListSortedCol, HasContactsGroupColumn, "List of groups this contact is part of.")
...
func NewHostsTable() (t *Table) {
	...
	t.AddColumn("check_interval", Static, Int64Col, "Number of basic interval lengths between two scheduled checks of the host")
	...
	t.AddColumn("childs", Static, StringListSortedCol, "A list of all direct childs of the host")
	t.AddColumn("contacts", Static, StringListSortedCol, "A list of all contacts of this host, either direct or via a contact group")
	t.AddColumn("contact_groups", Static, StringListSortedCol, "A list of all contact groups this host is in")
	t.AddColumn("current_attempt", Dynamic, Int64Col, "Number of the current check attempts")
	t.AddColumn("current_notification_number", Dynamic, Int64Col, "Number of the current notification")
	...
	t.AddColumn("first_notification_delay", Static, Int64Col, "Delay before the first notification")
	t.AddColumn("flap_detection_enabled", Dynamic, IntCol, "Whether flap detection is enabled (0/1)")
	t.AddColumn("groups", Static, StringListSortedCol, "A list of all host groups this host is in")
	...
	t.AddColumn("high_flap_threshold", Static, Int64Col, "High threshold of flap detection")
	...
	t.AddColumn("in_check_period", Dynamic, IntCol, "Boolean flag if the host is currently in its check period")
	t.AddColumn("in_notification_period", Dynamic, IntCol, "Boolean flag if the host is currently in its notification period")
	...
	t.AddColumn("last_hard_state_change", Dynamic, Int64Col, "The effective hard state of the host (eliminates a problem in hard_state)")
	...
	t.AddColumn("last_state_change", Dynamic, Int64Col, "State before last state change")
	...
	t.AddColumn("low_flap_threshold", Static, Int64Col, "Low threshold of flap detection")
	...
	t.AddColumn("num_services_crit", Dynamic, Int64Col, "The number of the host's services with the soft state CRIT")
	t.AddColumn("num_services_ok", Dynamic, Int64Col, "The number of the host's services with the soft state OK")
	t.AddColumn("num_services_pending", Dynamic, Int64Col, "The number of the host's services which have not been checked yet (pending)")
	t.AddColumn("num_services_unknown", Dynamic, Int64Col, "The number of the host's services with the soft state UNKNOWN")
	t.AddColumn("num_services_warn", Dynamic, Int64Col, "The number of the host's services with the soft state WARN")
	t.AddColumn("num_services_hard_crit", Dynamic, Int64Col, "The number of the host's services with the hard state CRIT")
	t.AddColumn("num_services_hard_ok", Dynamic, Int64Col, "The number of the host's services with the hard state OK")
	t.AddColumn("num_services_hard_unknown", Dynamic, Int64Col, "The number of the host's services with the hard state UNKNOWN")
	t.AddColumn("num_services_hard_warn", Dynamic, Int64Col, "The number of the host's services with the hard state WARN")
	...
	t.AddColumn("notification_interval", Static, Int64Col, "Interval of periodic notification or 0 if its off")
	...
	t.AddColumn("parents", Static, StringListSortedCol, "A list of all direct parents of the host")
	...
	t.AddColumn("retry_interval", Static, Int64Col, "Number of basic interval lengths between checks when retrying after a soft error")
	t.AddColumn("scheduled_downtime_depth", Dynamic, IntCol, "The number of downtimes this host is currently in")
	t.AddColumn("services", Static, StringListSortedCol, "The services associated with the host")
	...
	t.AddExtraColumn("depends_exec", LocalStore, Static, StringListSortedCol, HasDependencyColumn, "List of hosts this hosts depends on for execution")
	t.AddExtraColumn("depends_notify", LocalStore, Static, StringListSortedCol, HasDependencyColumn, "List of hosts this hosts depends on for notification")
	...
	t.AddExtraColumn("custom_variables", VirtualStore, None, CustomVarCol, NoFlags, "A dictionary of the custom variables")
	t.AddExtraRefColumn("services_with_info", VirtualStore, None, InterfaceListCol, TableServices, "The services, including info, that is associated with the host")
	t.AddExtraRefColumn("services_with_state", VirtualStore, None, InterfaceListCol, TableServices, "The services, including state info, that is associated with the host")
	t.AddExtraRefColumn("comments_with_info", VirtualStore, None, InterfaceListCol, TableComments, "A list of all comments of the host with id, author and comment")
	t.AddExtraRefColumn("downtimes_with_info", VirtualStore, None, InterfaceListCol, TableDowntimes, "A list of all downtimes of the host with id, author and comment")
	t.AddPeerInfoColumn("lmd_last_cache_update", FloatCol, "Timestamp of the last LMD update of this object")
	t.AddPeerInfoColumn("peer_key", StringCol, "Id of this peer")
	t.AddPeerInfoColumn("peer_name", StringCol, "Name of this peer")
	...
	t.AddExtraColumn("total_services", VirtualStore, None, Int64Col, NoFlags, "The total number of services of the host")
...
func NewHostgroupsTable() (t *Table) {
	...
	t.AddColumn("num_hosts_up", Dynamic, Int64Col, "The total number of up hosts of the hostgroup")
	t.AddColumn("num_hosts_down", Dynamic, Int64Col, "The total number of down hosts of the hostgroup")
	t.AddColumn("num_hosts_unreach", Dynamic, Int64Col, "The total number of unreachable hosts of the hostgroup")
	t.AddColumn("num_hosts_pending", Dynamic, Int64Col, "The total number of down hosts of the hostgroup")
	t.AddColumn("num_services", Static, Int64Col, "The total number of services of the hostgroup")
	t.AddColumn("num_services_ok", Dynamic, Int64Col, "The total number of ok services of the hostgroup")
	t.AddColumn("num_services_warn", Dynamic, Int64Col, "The total number of warning services of the hostgroup")
	t.AddColumn("num_services_crit", Dynamic, Int64Col, "The total number of critical services of the hostgroup")
	t.AddColumn("num_services_unknown", Dynamic, Int64Col, "The total number of unknown services of the hostgroup")
	t.AddColumn("num_services_pending", Dynamic, Int64Col, "The total number of pending services of the hostgroup")
	t.AddColumn("num_services_hard_crit", Dynamic, Int64Col, "The total number of services with the state CRIT of hosts in this group")
	t.AddColumn("num_services_hard_ok", Dynamic, Int64Col, "The total number of services with the state OK of hosts in this group")
	t.AddColumn("num_services_hard_unknown", Dynamic, Int64Col, "The total number of services with the state UNKNOWN of hosts in this group")
	t.AddColumn("num_services_hard_warn", Dynamic, Int64Col, "The total number of services with the state WARN of hosts in this group")
...
func NewServicesTable() (t *Table) {
	...
	t.AddColumn("check_interval", Static, Int64Col, "Number of basic interval lengths between two scheduled checks of the service")
	...
	t.AddColumn("contacts", Static, StringListSortedCol, "A list of all contacts of the service, either direct or via a contact group")
	t.AddColumn("contact_groups", Static, StringListSortedCol, "A list of all contact groups this service is in")
	t.AddColumn("current_attempt", Dynamic, Int64Col, "The number of the current check attempt")
	...
	t.AddColumn("first_notification_delay", Dynamic, Int64Col, "Delay before the first notification")
	t.AddColumn("flap_detection_enabled", Dynamic, IntCol, "Whether flap detection is enabled for the service (0/1)")
	t.AddColumn("groups", Static, StringListSortedCol, "A list of all service groups the service is in")
	...
	t.AddColumn("in_check_period", Dynamic, IntCol, "Boolean flag if the service is currently in its check period")
	t.AddColumn("in_notification_period", Dynamic, IntCol, "Boolean flag if the service is currently in its notification period")
	...
	t.AddColumn("last_hard_state_change", Dynamic, Int64Col, "The last hard state of the service")
	...
	t.AddColumn("last_state_change", Dynamic, Int64Col, "The last state of the service")
	...
	t.AddColumn("low_flap_threshold", Dynamic, Int64Col, "Low threshold of flap detection")
	t.AddColumn("max_check_attempts", Static, Int64Col, "The maximum number of check attempts")
	t.AddColumn("modified_attributes", Dynamic, Int64Col, "A bitmask specifying which attributes have been modified")
	t.AddColumn("modified_attributes_list", Dynamic, StringListSortedCol, "A bitmask specifying which attributes have been modified")
	...
	t.AddExtraColumn("parents", LocalStore, Static, ServiceMemberListCol, HasServiceParentsColumn, "List of services descriptions this services depends on")
	...
	t.AddExtraColumn("custom_variables", VirtualStore, None, CustomVarCol, NoFlags, "A dictionary of the custom variables")
	t.AddExtraRefColumn("comments_with_info", VirtualStore, None, InterfaceListCol, TableComments, "A list of all comments of the host with id, author and comment")
	t.AddExtraRefColumn("downtimes_with_info", VirtualStore, None, InterfaceListCol, TableDowntimes, "A list of all downtimes of the service with id, author and comment")
	t.AddPeerInfoColumn("lmd_last_cache_update", FloatCol, "Timestamp of the last LMD update of this object")
	t.AddPeerInfoColumn("peer_key", StringCol, "Id of this peer")
	t.AddPeerInfoColumn("peer_name", StringCol, "Name of this peer")
	t.AddExtraColumn("last_state_change_order", VirtualStore, None, Int64Col, NoFlags,
...
func NewServicegroupsTable() (t *Table) {
	...
	t.AddColumn("num_services_ok", Dynamic, Int64Col, "The total number of ok services of the service group")
	t.AddColumn("num_services_warn", Dynamic, Int64Col, "The total number of warning services of the service group")
	t.AddColumn("num_services_crit", Dynamic, Int64Col, "The total number of critical services of the service group")
	t.AddColumn("num_services_unknown", Dynamic, Int64Col, "The total number of unknown services of the service group")
	t.AddColumn("num_services_pending", Dynamic, Int64Col, "The total number of pending services of the service group")
	t.AddColumn("num_services_hard_crit", Dynamic, Int64Col, "The number of services in the group that are CRIT")
	t.AddColumn("num_services_hard_ok", Dynamic, Int64Col, "The number of services in the group that are OK")
	t.AddColumn("num_services_hard_unknown", Dynamic, Int64Col, "The number of services in the group that are UNKNOWN")
	t.AddColumn("num_services_hard_warn", Dynamic, Int64Col, "The number of services in the group that are WARN")
...
func NewLogTable() (t *Table) {
	t = &Table{name: TableLog, passthroughOnly: true, defaultSort: []string{"time"}}

	t.AddColumn("attempt", Static, Int64Col, "The number of the check attempt")
	...
	t.AddColumn("lineno", Static, Int64Col, "The number of the line in the log file")
...
func NewHostsByGroupTable() (t *Table) {
	t = &Table{name: TableHostsbygroup, virtual: GetGroupByData}
	t.AddColumn("name", Static, StringCol, "Host name")
...
func NewServicesByGroupTable() (t *Table) {
	t = &Table{name: TableServicesbygroup, virtual: GetGroupByData}
	t.AddColumn("host_name", Static, StringCol, "Host name")
...
func NewServicesByHostgroupTable() (t *Table) {
	t = &Table{name: TableServicesbyhostgroup, virtual: GetGroupByData}
	t.AddColumn("host_name", Static, StringCol, "Host name")
	t.AddColumn("description", Static, StringCol, "Service description")
	t.AddColumn("hostgroup_name", Static, StringCol, "Host group name")
